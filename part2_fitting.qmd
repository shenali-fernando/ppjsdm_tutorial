...
If parameters are misspecified in the fit you will see this warning message, and/or the interaction coefficient (alpha) matrix will be NULL (for a quick check run `coef(fit$alpha[[1]])` for this). 
