...
The short-range interaction radii has to be a matrix for each pair of groups in the data. We can do this by supplying a matrix. I will choose 3.75 as my interaction radius. Please refer to ppjsdm_tutorial/part1_parameterisation.qmd for further short-range parameterisation details.
...
And I will choose bumpas the shape or model of my short-range potential.
